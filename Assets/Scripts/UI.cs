...
//         Util.WaitForTimerUntil(BACKGROUND_UNLOAD_DURATION, () => this.UnloadComponent("splash", UI.LoadAction.Immediately));
//       });
...
//       Util.WaitForTimerUntil(unloadDuration, (_, _) => this.background.texture = null!);
//     }
//   }
