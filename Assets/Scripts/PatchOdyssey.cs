...
namespace PatchOdyssey /* ⟶ Class types and delegates */ {
  ...
  namespace Collections {
    public sealed class EventHandler<T> : PatchOdyssey.Collections.IRefReadOnlyEquatable<EventHandler<T>>, PatchOdyssey.Collections.RefList<PatchOdyssey.Collections.HandlerInfo<T>>, System.ICloneable where T : PatchOdyssey.Events, new() /* ⟶ `event` @ `https://web.archive.org/web/20220923174214/https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/event` */ {
      ...
      [PatchMethod(AggressiveInlining)] public                     bool                                                                                 Equals                                                                (in EventHandler<T>                                                                                                        events)                                                                                                   =>     base.Equals       ((PatchOdyssey.Collections.RefList<PatchOdyssey.Collections.HandlerInfo<T>>) value);
    ...
    public interface IRefComparable<T> : PatchOdyssey.Collections.IRefReadOnlyComparable<T> {
      public bool CompareTo(ref T value);
    }
    ...
    public interface IRefReadOnlyComparable<T> : System.IComparable<T>, System.IComparable {
      public bool CompareTo(in T value);
    }
    ...
    public /* sealed */ class RefComparer<T> : System.Collections.Generic.Comparer<T>, System.Collections.Generic.IComparer<T>, System.Collections.IComparer {
      ...
      private        new readonly PatchOdyssey.RefComparison<T> comparison       = RefComparer<T>.CompareValue;
      public  static new          RefComparer               <T> Default { get; } = new();

      /* … */
      [PatchMethod(AggressiveInlining)] public  RefComparer()                                                 : base()           {}
      [PatchMethod(AggressiveInlining)] private RefComparer(PatchOdyssey.RefComparison        <T> comparison) : base()           this.comparison = comparison;
      [PatchMethod(AggressiveInlining)] private RefComparer(PatchOdyssey.RefReadOnlyComparison<T> comparison) : base(comparison) {}
      ...
      [PatchMethod(AggressiveInlining)] public  override        int            Compare                                                 (in  T                                 a, in  T b)                                                                => this.RefReadOnlyCompare(in a, in b);
      ...
      [PatchMethod(AggressiveInlining)] bool                                   PatchOdyssey.Collections.IRefComparer<T>.Compare        (ref T                                 a, ref T   b)                                                              => this.Compare           (ref a, ref b);
      [PatchMethod(AggressiveInlining)] bool                                   PatchOdyssey.Collections.IRefReadOnlyComparer<T>.Compare(in  T                                 a, in  T   b)                                                              => this.RefReadOnlyCompare(in  a, in  b);
    ...
    public class RefDictionary<TKey, TValue> : PatchOdyssey.Collections.IRefEquatable<RefDictionary<TKey, TValue>>, System.Collections.Generic.IDictionary<TKey, TValue>, System.Collections.ICollection, System.Collections.IDictionary /* ⟶ Based on `System.Collections.Generic.Dictionary<TKey, TValue>`; See `https://web.archive.org/web/20240722203244/https://discussions.unity.com/t/finally-a-serializable-dictionary-for-unity-extracted-from-system-collections-generic/586385` */ {
      ...
      [PatchConstructor, PatchMethod(AggressiveInlining), PatchResolution(1)] public RefDictionary(System.Collections.Generic.IEnumerable      <PatchOdyssey.Collections.RefReadOnlyKeyValuePair<TKey, TValue>> enumerable, System.Collections.Generic.IEqualityComparer<TKey> comparer) : this(enumerable is null ? 0u : Util.EnumerableCount(enumerable),                                                  comparer) => this.AddRange(enumerable!);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)]                 bool                                                                                          PatchOdyssey.Collections.IRefEquatable<RefDictionary<TKey, TValue>>                                        (ref RefDictionary                      <TKey, TValue> dictionary)                     => this.Equals(in dictionary);
      [PatchMethod(AggressiveInlining), PatchResolution(0)]                 bool                                                                                          PatchOdyssey.Collections.IRefReadOnlyEquatable<RefDictionary<TKey, TValue>>                                (in  RefDictionary                      <TKey, TValue> dictionary)                     => this.Equals(in dictionary);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)]                 bool                                                                                          System.IEquatable<RefDictionary<TKey, TValue>>                                                             (RefDictionary<TKey, TValue> dictionary)                                               => this.Equals       (dictionary);
    ...
    public /* sealed */ class RefEqualityComparer<T> : PatchOdyssey.Collections.IRefEqualityComparer<T>, PatchOdyssey.Collections.RefReadOnlyEqualityComparer<T> {
      ...
      /* … */
      [PatchMethod(AggressiveInlining)] public  virtual  bool Equals                                                              (ref T   a, ref T b)                                                             => RefEqualityComparer<T>.EqualsValue(ref a, ref b);
      [PatchMethod(AggressiveInlining)] public  override bool Equals                                                              (in  T   a, in  T b)                                                             => this.RefReadOnlyEquals            (in  a, in  b);
      [PatchMethod(AggressiveInlining)] public  override bool Equals                                                              (T       a, T     b)                                                             => a is null ? b is null : b is null ? a is null : this.RefReadOnlyEquals(in a, in b);
      [PatchMethod(AggressiveInlining)] private static   bool EquatableEquals<U>                                                  (ref U   a, ref U b) where U : System.IEquatable<U>                              => a.Equals(b);
      [PatchMethod(AggressiveInlining)] public  virtual  int  GetHashCode                                                         (ref T   value)                                                                  => value.GetHashCode();
      [PatchMethod(AggressiveInlining)] public  override int  GetHashCode                                                         (in  T   value)                                                                  => this.RefReadOnlyGetHashCode(in value);
      [PatchMethod(AggressiveInlining)] public  override int  GetHashCode                                                         (T       value)                                                                  => this.RefReadOnlyGetHashCode(in value!);
      [PatchMethod(AggressiveInlining)] private static   bool ObjectEquals      <U>                                               (ref U   a, ref U b)                                                             => a!.Equals(b);
      [PatchMethod(AggressiveInlining)] private static   bool RefEquatableEquals<U>                                               (ref U   a, ref U b) where U : PatchOdyssey.Collections.IRefEquatable<U>         => a .Equals(ref b);
      [PatchMethod(AggressiveInlining)] private          bool RefReadOnlyEquals                                                   (in  T   a, in  T b)                                                             => base.Equals(in a, in b);
      [PatchMethod(AggressiveInlining)] private static   bool RefReadOnlyEquatableEquals<U>                                       (ref U   a, ref U b) where U : PatchOdyssey.Collections.IRefReadOnlyEquatable<U> => a.Equals(in b);
      [PatchMethod(AggressiveInlining)] private          int  RefReadOnlyGetHashCode                                              (in  T   value)                                                                  => base.GetHashCode(in  value);
      [PatchMethod(AggressiveInlining)] bool                  PatchOdyssey.Collections.IRefEqualityComparer<T>.Equals             (ref T   a, ref T b)                                                             => this.Equals     (ref a, ref b);
      [PatchMethod(AggressiveInlining)] int                   PatchOdyssey.Collections.IRefEqualityComparer<T>.GetHashCode        (ref T   value)                                                                  => this.GetHashCode(ref value);
      ...
      [PatchMethod(AggressiveInlining)] bool                  System.Collections.Generic.IEqualityComparer<T>.Equals              (T?      a, T?   b)                                                              => a is null ? b is null : b is null ? a is null : this.RefReadOnlyEquals(in a!, in b!);
      ...
      [PatchMethod(AggressiveInlining)] bool                  System.Collections.IEqualityComparer.Equals                         (object? a, object? b)                                                           => a is null ? b is null : b is null ? a is null : this.RefReadOnlyEquals((T) a, (T) b);
    ...
    [System.Serializable]
    public class RefList<T> : PatchOdyssey.Collections.IRefEquatable<RefList<T>>, PatchOdyssey.Collections.RefReadOnlyList<T>, System.Collections.Generic.IList<T>, System.Collections.ICollection, System.Collections.IList, System.Collections.IStructuralComparable, System.Collections.IStructuralEquatable, System.ICloneable {
      ...
      [PatchMethod(AggressiveInlining)] public                 bool                  Equals        (in RefList                       <T>    list)                                                                                               => object.Equals(list, this);
      ...
      [PatchMethod(AggressiveInlining)] public      bool       Remove                                                           (in T                                 element)                                                                     { int index = base.IndexOf(in element); if (index != -1) { this.RemoveAt((uint) index); return true; } return false; }
      ...
      [PatchMethod(AggressiveInlining)] bool                   PatchOdyssey.Collections.IRefEquatable<RefList<T>>.Equals        (ref RefList                      <T> list)                                                                        => this.Equals(in list);
      [PatchMethod(AggressiveInlining)] bool                   PatchOdyssey.Collections.IRefReadOnlyEquatable<RefList<T>>.Equals(in  RefList                      <T> list)                                                                        => this.Equals(in list);
      ...
      [PatchMethod(AggressiveInlining)] object                 System.ICloneable.Clone                                          ()                                                                                                                 => base    .Clone      ();
      [PatchMethod(AggressiveInlining)] bool                   System.IEquatable<RefList<T>>.Equals                             (RefList<T> list)                                                                                                  => this.Equals(list);
    ...
    public /* sealed */ class RefReadOnlyComparer<T> : System.Collections.Generic.Comparer<T>, System.Collections.Generic.IComparer<T>, System.Collections.IComparer {
      ...
      /* … */
      [PatchMethod(AggressiveInlining)] public  RefReadOnlyComparer()                                                 : base() {}
      [PatchMethod(AggressiveInlining)] private RefReadOnlyComparer(PatchOdyssey.RefReadOnlyComparison<T> comparison) : base() => this.comparison = comparison;
      ...
      [PatchMethod(AggressiveInlining)] bool                                    PatchOdyssey.Collections.IRefReadOnlyComparer<T>.Compare(in T                                  a, in T    b)                                                              => this.Compare(in a, in b);
    ...
    [System.Serializable]
    public class RefReadOnlyDictionary<TKey, TValue> : PatchOdyssey.Collections.IRefEquatable<RefReadOnlyDictionary<TKey, TValue>>, PatchOdyssey.Collections.RefDictionary<TKey, TValue>, System.Collections.Generic.IDictionary<TKey, TValue>, System.Collections.Generic.IReadOnlyDictionary<TKey, TValue>, System.Collections.IDictionary /* ⟶ Retroactively designed after `RefDictionary<…>`’s implementation */ {
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] bool                                                      PatchOdyssey.Collections.IReadOnlyRefEquatable<RefReadOnlyDictionary<TKey, TValue>>.Equals(in  RefReadOnlyDictionary<TKey, TValue>                   dictionary)                                                        => this.Equals     (in dictionary);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] void                                                      System.Collections.Generic.IDictionary<TKey, TValue>.Add                                  (TKey                                                      key, TValue    value)                                              => this.Add        (in key, in value);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] bool                                                      System.Collections.Generic.IDictionary<TKey, TValue>.ContainsKey                          (TKey                                                      key)                                                               => this.ContainsKey(in key);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] bool                                                      System.Collections.Generic.IDictionary<TKey, TValue>.Remove                               (TKey                                                      key)                                                               => this.Remove     (in key);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] bool                                                      System.Collections.Generic.IDictionary<TKey, TValue>.TryGetValue                          (TKey                                                      key, out TValue value)                                             => this.TryGetValue(in key, out value);
    ...
    public /* sealed */ class RefReadOnlyEqualityComparer<T> : PatchOdyssey.Collections.IRefReadOnlyEqualityComparer<T>, System.Collections.Generic.EqualityComparer<T> {
      private abstract class Sentinel : PatchOdyssey.Collections.IRefReadOnlyEquatable<Sentinel> {
        bool PatchOdyssey.Collections.IRefReadOnlyEquatable<Sentinel>.Equals(in Sentinel value) => default;
        bool System.IEquatable<Sentinel>.Equals                             (Sentinel    value) => default;
      }
      ...
      /* … */
      [PatchMethod(AggressiveInlining)] public  virtual  bool Equals                                                              (in T    a, in T b)                                                             => RefReadOnlyEqualityComparer<T>.EqualsValue(in a, in b);
      ...
      [PatchMethod(AggressiveInlining)] public  virtual  int  GetHashCode                                                         (in T    value)                                                                 => value .GetHashCode();
      [PatchMethod(AggressiveInlining)] public  override int  GetHashCode                                                         (T       value)                                                                 => value!.GetHashCode();
      [PatchMethod(AggressiveInlining)] private static   bool ObjectEquals              <U>                                       (in U    a, in U b)                                                             => a!.Equals(b);
    ...
    public class RefReadOnlyList<T> : PatchOdyssey.Collections.IRefEquatable<RefReadOnlyList<T>>, System.Collections.Generic.IEnumerable<T>, System.Collections.Generic.IReadOnlyList<T>, System.Collections.IStructuralComparable, System.Collections.IStructuralEquatable, System.ICloneable /* ⟶ Based on `System.Collections.Generic.List<T>` and `System.Collections.ObjectModel.ReadOnlyCollection<T>` */ {
      ...
      [PatchMethod(AggressiveInlining)] bool                                            PatchOdyssey.Collections.IRefEquatable<T>.Equals        (ref RefReadOnlyList              <T> list)                                                                                                                         => this.Equals(in list);
      [PatchMethod(AggressiveInlining)] bool                                            PatchOdyssey.Collections.IRefReadOnlyEquatable<T>.Equals(in  RefReadOnlyList              <T> list)                                                                                                                         => this.Equals(in list);
      ...
      [PatchMethod(AggressiveInlining)] bool                                            System.IEquatable<T>.Equals                             (RefReadOnlyList<T> list)                                                                                                                                           => this    .Equals     (list);
    ...
    public class RefSortedCollection<TSort, T> : PatchOdyssey.Collections.IRefEquatable<RefSortedCollection<TSort, T>>, System.Collections.Generic.IList<T>, System.Collections.ICollection, System.Collections.IList, System.Collections.IStructuralComparable, System.Collections.IStructuralEquatable, System.ICloneable /* ⟶ No read-only analogue */ {
      ...
      public  readonly System.Collections.Generic.IComparer<TSort>     Comparer                                             =  System.Collections.Generic.Comparer<TSort>.Default;
      ...
      [PatchMethod(AggressiveInlining)] public RefSortedCollection(System.Collections.Generic.IComparer  <TSort>    comparer)                                                         : this(0u,                      comparer) {}
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          bool                                           Equals                                                                              (in RefSortedCollection           <T>                    collection)                                                                                            => object.Equals(collection, this);
...
namespace PatchOdyssey /* ⟶ …everything else */ {
  ...
  public static partial class Util /* ⟶ Utilities */ {
    ...
    public static class Wait {
      ...
      /* … */
      // internal static readonly PatchOdyssey.Collections.RefSortedCollection
