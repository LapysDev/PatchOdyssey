...
namespace PatchOdyssey /* ⟶ Class types and delegates */ {
  ...
  namespace Collections {
    ...
    public /* sealed */ class RefComparer<T> : PatchOdyssey.Collections.RefReadOnlyComparer<T>, PatchOdyssey.Collections.IRefComparer<T> {
      ...
      [PatchMethod(AggressiveInlining)] protected RefComparer(PatchOdyssey.RefComparison        <T> comparison) : base()           => this.comparison = comparison;
      [PatchMethod(AggressiveInlining)] protected RefComparer(PatchOdyssey.RefReadOnlyComparison<T> comparison) : base(comparison) {}
    ...
    public /* sealed */ class RefReadOnlyComparer<T> : System.Collections.Generic.Comparer<T>, PatchOdyssey.Collections.IRefReadOnlyComparer<T>, System.Collections.Generic.IComparer<T>, System.Collections.IComparer {
      ...
      [PatchMethod(AggressiveInlining)] protected RefReadOnlyComparer(PatchOdyssey.RefReadOnlyComparison<T> comparison) : base() => this.comparison = comparison;
