...
namespace PatchOdyssey /* ⟶ Class types and delegates */ {
  ...
  namespace Collections {
    ...
    public class RefSortedCollection<TSort, T> : PatchOdyssey.Collections.IRefEquatable<RefSortedCollection<TSort, T>>, System.Collections.Generic.IList<T>, System.Collections.ICollection, System.Collections.IList, System.Collections.IStructuralComparable, System.Collections.IStructuralEquatable, System.ICloneable /* ⟶ No read-only analogue */ {
      ...
      [PatchMethod(AggressiveInlining)] public RefSortedCollection(uint                                                    capacity,   PatchOdyssey.Collections.IRefReadOnlyComparer<TSort> comparer)                                           { this.Comparer = comparer; this.items.EnsureCapacity(capacity); this.ranks.EnsureCapacity(capacity); }
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(1)] public          T?                                             Find                                                                                (PatchOdyssey.RefReadOnlyPredicate<T>                    predicate)                                                                                             => this.items.Find         (predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(1)] public          T?                                             FindLast                                                                            (PatchOdyssey.RefReadOnlyPredicate<T>                    predicate)                                                                                             => this.items.FindLast     (predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          bool                                           RemoveRank                                                                          (in TSort                                              rank)                                                                                                    { int index = this.ranks.IndexOf(in rank); if (index != -1) { this.RemoveAt((uint) index); return true; } return false; }
      [PatchMethod(AggressiveInlining), PatchResolution(1)] public          bool                                           RemoveRank                                                                          (in PatchOdyssey.Collections.RefKeyValuePair<TSort, T> element)                                                                                                 => this.Remove(in element);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          bool                                           RemoveRank                                                                          (in System.Collections.Generic.KeyValuePair <TSort, T> element)                                                                                                 => this.Remove(in element);
