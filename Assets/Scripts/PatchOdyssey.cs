...
namespace PatchOdyssey /* ⟶ Class types and delegates */ {
  ...
  namespace Collections {
    public sealed class EventHandler<T> : PatchOdyssey.Collections.RefList<PatchOdyssey.Collections.HandlerInfo<T>>, PatchOdyssey.Collections.IRefReadOnlyEquatable<EventHandler<T>>, System.ICloneable where T : PatchOdyssey.Events, new() /* ⟶ `event` @ `https://web.archive.org/web/20220923174214/https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/event` */ {
      ...
      [PatchMethod(AggressiveInlining)] public                     bool                                                                                 Equals                                                                (in EventHandler<T>                                                                                                        events)                                                                                                   =>     base.Equals       ((PatchOdyssey.Collections.RefList<PatchOdyssey.Collections.HandlerInfo<T>>) events);
      ...
      [PatchMethod(AggressiveInlining)] bool                                                                                                            PatchOdyssey.Collections.IRefReadOnlyEquatable<EventHandler<T>>.Equals(in EventHandler                  <T>                                       events)                                                                                                                                                  => this.Equals     (in events);
      [PatchMethod(AggressiveInlining)] object                                                                                                          System.ICloneable.Clone                                               ()                                                                                                                                                                                                                                   => base.Clone      ();
      [PatchMethod(AggressiveInlining)] bool                                                                                                            System.IEquatable<EventHandler<T>>.Equals                             (EventHandler<T> events)                                                                                                                                                                                                             => this.Equals     (events);
    ...
    public struct HandlerInfo<T> : PatchOdyssey.Collections.IRefReadOnlyEquatable<HandlerInfo<T>> where T : PatchOdyssey.Events, new() /* ⟶ Based on `System.MulticastDelegate` */ {
      ...
      internal          T                       metadata = default!;                    // ⟶ Callback event data
    ...
    internal struct LoadInfo : PatchOdyssey.Collections.IRefEquatable<LoadInfo> {
      ...
      [PatchConstructor, PatchMethod(AggressiveInlining)] internal LoadInfo(in PatchOdyssey.Collections.HandlerInfo<PatchOdyssey.Events.LoadEvent> handler) => this.events.Add(handler);
    ...
    public /* sealed */ class RefComparer<T> : PatchOdyssey.Collections.RefReadOnlyComparer<T>, PatchOdyssey.Collections.IRefComparer<T> {
      private abstract class Sentinel : PatchOdyssey.Collections.IRefComparable<Sentinel> {
      ...
      /* … */
      private static new readonly PatchOdyssey.RefComparison<T> CompareValue = (PatchOdyssey.RefComparison<T>) (
      ...
      private        readonly PatchOdyssey.RefComparison<T> comparison       = RefComparer<T>.CompareValue;
    ...
    public class RefDictionary<TKey, TValue> : PatchOdyssey.Collections.IRefEquatable<RefDictionary<TKey, TValue>>, System.Collections.Generic.IDictionary<TKey, TValue>, System.Collections.ICollection, System.Collections.IDictionary /* ⟶ Based on `System.Collections.Generic.Dictionary<TKey, TValue>`; See `https://web.archive.org/web/20240722203244/https://discussions.unity.com/t/finally-a-serializable-dictionary-for-unity-extracted-from-system-collections-generic/586385` */ {
      ...
      [PatchConstructor, PatchMethod(AggressiveInlining), PatchResolution(0)] public RefDictionary(uint                                                                                                          capacity,   PatchOdyssey.Collections.IRefEqualityComparer<TKey> comparer)                                                                                                                               { RefDictionary<TKey, TValue>.Ensure(); this.Initialize(capacity); this.Comparer = comparer ?? PatchOdyssey.Collections.RefEqualityComparer<TKey>.Default; }
      ...
      [PatchMethod(AggressiveInlining)] public void EnsureCapacity(uint                           capacity)   { /* Do nothing… */ }
      [PatchMethod(AggressiveInlining)] public bool Equals        (in RefDictionary<TKey, TValue> dictionary) => object.Equals(dictionary, this);
    ...
    public /* sealed */ class RefEqualityComparer<T> : PatchOdyssey.Collections.RefReadOnlyEqualityComparer<T>, PatchOdyssey.Collections.IRefEqualityComparer<T> {
      private abstract class Sentinel : PatchOdyssey.Collections.IRefEquatable<Sentinel> {
      ...
      /* … */
      private static new readonly PatchOdyssey.RefHasher            <T> GetHashCodeValue = [PatchMethod(AggressiveInlining)] static (ref T value) => value!.GetHashCode();
      private static new readonly PatchOdyssey.RefEqualityComparison<T> EqualsValue      = (PatchOdyssey.RefEqualityComparison<T>) (
      ...
      private        readonly PatchOdyssey.RefEqualityComparison<T> comparison       = RefEqualityComparer<T>.EqualsValue;
      private        readonly PatchOdyssey.RefHasher            <T> hasher           = RefEqualityComparer<T>.GetHashCodeValue;
      ...
      [PatchConstructor, PatchMethod(AggressiveInlining), PatchResolution(0)] protected RefEqualityComparer(PatchOdyssey.RefEqualityComparison        <T> comparison, PatchOdyssey.RefReadOnlyHasher<T>? hasher) : base()                   { base.hasher = hasher ?? this.hasher; this.comparison = comparison; }
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(1)] public  new      static RefEqualityComparer<T> Create                                                              (PatchOdyssey.RefReadOnlyEqualityComparison<T> comparison, PatchOdyssey.RefHasher        <T>? hasher = null)                    => new(comparison, hasher);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public  virtual         int                    GetHashCode                                                         (ref T                                         value)                                                                           => this.hasher(value!);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] private                 bool                   RefReadOnlyEquals                                                   (in  T                                         a, in  T b)                                                                      { if (RefEqualityComparer<T>.EqualsValue != this.hasher) throw new System.NotSupportedException("Reference equality comparer can not compare as modifiable references"); return base.Equals(in a, in b); }
    ...
    public class RefList<T> : PatchOdyssey.Collections.RefReadOnlyList<T>, PatchOdyssey.Collections.IRefEquatable<RefList<T>>, System.Collections.Generic.IList<T>, System.Collections.ICollection, System.Collections.IList, System.Collections.IStructuralComparable, System.Collections.IStructuralEquatable, System.ICloneable {
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           ref readonly T        Append        (in T                                      element)                                                                                          {  this.Insert     (this.Count, in element); return ref element; }
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           RefList<U>            ConvertAll<U> (PatchOdyssey.RefConverter        <T, U> converter)                                                                                          { RefList<U> list = new(this.Count); for (; list.Count != this.Count; ++list.Count) { list.SetValue(converter(ref this.GetValue(list.Count)), list.Count); } return list; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    RefList<U>            ConvertAll<U> (PatchOdyssey.RefReadOnlyConverter<T, U> converter)                                                                                          => this.ConvertAll([PatchMethod(AggressiveInlining)] (ref T element) => converter(in element));
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           bool                  Exists        (PatchOdyssey.RefPredicate        <T>    predicate)                                                                                          { for (uint index = 0u; index != this.Count; ++index) { if (predicate(ref this.GetValue(index))) return true; } return false; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    bool                  Exists        (PatchOdyssey.RefReadOnlyPredicate<T>    predicate)                                                                                          => base      .Exists(predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           T?                    Find          (PatchOdyssey.RefPredicate        <T>    predicate)                                                                                          { for (uint index = 0u; index != this.Count; ++index) { ref T element = ref this.GetValue(index); if (predicate(ref element)) return element; } return default; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    T?                    Find          (PatchOdyssey.RefReadOnlyPredicate<T>    predicate)                                                                                          => base.Find(predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    T?                    Find          (System.Predicate                 <T>    predicate)                                                                                          => base.Find(predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           RefList<T>            FindAll       (PatchOdyssey.RefPredicate        <T>    predicate)                                                                                          { RefList<T> list = new(this.Count); for (uint index = 0u; index != this.Count; ++index) { ref T element = ref this.GetValue(index); if (predicate(ref element)) list.SetValue(in element, list.Count++); } list.TrimExcess(); return list; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    RefList<T>            FindAll       (PatchOdyssey.RefReadOnlyPredicate<T>    predicate)                                                                                          => this.FindAll  ([PatchMethod(AggressiveInlining)] (ref T element) => predicate(in element));
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           int                   FindIndex     (PatchOdyssey.RefPredicate        <T>    predicate)                                                                                          => this.FindIndex(0u, this.Count, predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    int                   FindIndex     (PatchOdyssey.RefReadOnlyPredicate<T>    predicate)                                                                                          => base.FindIndex(predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           int                   FindIndex     (uint                                    index, PatchOdyssey.RefPredicate        <T> predicate)                                              { for (; index < this.Count; ++index) { if (predicate(ref this.GetValue(index))) return (int) index; } return -1; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    int                   FindIndex     (uint                                    index, PatchOdyssey.RefReadOnlyPredicate<T> predicate)                                              => base.FindIndex(index, predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           int                   FindIndex     (uint                                    index, uint                                 length, PatchOdyssey.RefPredicate        <T> predicate) { for (uint end = System.Math.Min(this.Count, index + length); index < end; ++index) { if (predicate(ref this.GetValue(index))) return (int) index; } return -1; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    int                   FindIndex     (uint                                    index, uint                                 length, PatchOdyssey.RefReadOnlyPredicate<T> predicate) => base.FindIndex(index, length, predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           T?                    FindLast      (PatchOdyssey.RefPredicate        <T>    predicate)                                                                                          { for (uint index = this.Count; 0 != index--; ) { ref T element = ref this.GetValue(index); if (predicate(ref element)) return element; } return default; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    T?                    FindLast      (PatchOdyssey.RefReadOnlyPredicate<T>    predicate)                                                                                          => base.FindLast     (predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    T?                    FindLast      (System.Predicate                 <T>    predicate)                                                                                          => base.FindLast     (predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           int                   FindLastIndex (PatchOdyssey.RefPredicate        <T>    predicate)                                                                                          => this.FindLastIndex(0u, this.Count, predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    int                   FindLastIndex (PatchOdyssey.RefReadOnlyPredicate<T>    predicate)                                                                                          => base.FindLastIndex(predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           int                   FindLastIndex (uint                                    index, PatchOdyssey.RefPredicate        <T> predicate)                                              { for (uint end = this.Count; end-- > index; ) { if (predicate(ref this.GetValue(end))) return (int) end; } return -1; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    int                   FindLastIndex (uint                                    index, PatchOdyssey.RefReadOnlyPredicate<T> predicate)                                              => base.FindLastIndex(index, predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           int                   FindLastIndex (uint                                    index, uint                                 length, PatchOdyssey.RefPredicate        <T> predicate) { for (uint end = System.Math.Min(this.Count, index + length); end-- > index; ) { if (predicate(ref this.GetValue(end))) return (int) end; } return -1; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public    new    int                   FindLastIndex (uint                                    index, uint                                 length, PatchOdyssey.RefReadOnlyPredicate<T> predicate) => base.FindLastIndex(index, length, predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public           void                  ForEach       (PatchOdyssey.RefAction        <T>       action)                                                                                             { for (uint index = 0u; index != this.Count; ++index) action(ref this.GetValue(index)); }
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public      void       Sort                                                             ()                                                                                                                                   => this.Sort(0u, base.Count, PatchOdyssey.Collections.RefComparer<T>.Default.Compare);
      [PatchMethod(AggressiveInlining), PatchResolution(6)] public      void       Sort                                                             (PatchOdyssey.Collections.IRefComparer        <T>? comparer)                                                                         => this.Sort(0u, base.Count, comparer?.Compare ?? PatchOdyssey.Collections.RefComparer        <T>.Default.Compare);
      [PatchMethod(AggressiveInlining), PatchResolution(5)] public      void       Sort                                                             (PatchOdyssey.Collections.IRefReadOnlyComparer<T>? comparer)                                                                         => this.Sort(0u, base.Count, comparer?.Compare ?? PatchOdyssey.Collections.RefReadOnlyComparer<T>.Default.Compare);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(4)] public      void       Sort                                                             (System.Collections.Generic.IComparer         <T>? comparer)                                                                         => this.Sort(0u, base.Count, comparer?.Compare ?? System.Collections.Generic.Comparer<T>.Default.Compare);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(3)] public      void       Sort                                                             (uint                                              index, uint length, PatchOdyssey.Collections.IRefComparer        <T>? comparer)   => this.Sort(index, System.Math.Min(base.Count, index + length), comparer?.Compare ??                                                                                          PatchOdyssey.Collections.RefComparer<T>.Default.Compare);
      [PatchMethod(AggressiveInlining), PatchResolution(1)] public      void       Sort                                                             (uint                                              index, uint length, PatchOdyssey.Collections.IRefReadOnlyComparer<T>? comparer)   => this.Sort(index, System.Math.Min(base.Count, index + length), comparer is not null ? [PatchMethod(AggressiveInlining)] (ref T a, ref T b) => comparer.Compare(in a, in b) : PatchOdyssey.Collections.RefComparer<T>.Default.Compare);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] private     void       Sort                                                             (uint                                              begin, uint end,    PatchOdyssey.RefComparison                   <T>  comparison) { if (base.Count <= 16u) this.InsertionSort(begin, end, comparison); else if (base.Count > System.Math.Log(base.Count) * 2.0) this.HeapSort(begin, end, comparison); else this.QuickSort(begin, end - 1u, comparison); }
    ...
    public /* sealed */ class RefReadOnlyComparer<T> : System.Collections.Generic.Comparer<T>, PatchOdyssey.Collections.IRefReadOnlyComparer<T>, System.Collections.Generic.IComparer<T>, System.Collections.IComparer {
      ...
      private        readonly PatchOdyssey.RefReadOnlyComparison<T> comparison       = RefReadOnlyComparer<T>.CompareValue;
    ...
    public /* sealed */ class RefReadOnlyEqualityComparer<T> : System.Collections.Generic.EqualityComparer<T>, PatchOdyssey.Collections.IRefReadOnlyEqualityComparer<T> {
      ...
      private        readonly PatchOdyssey.RefReadOnlyEqualityComparison<T> comparison       = RefReadOnlyEqualityComparer<T>.EqualsValue;
      private        readonly PatchOdyssey.RefReadOnlyHasher            <T> hasher           = RefReadOnlyEqualityComparer<T>.GetHashCodeValue;
      ...
      /* … */
      [PatchMethod(AggressiveInlining)] public  new      static RefReadOnlyEqualityComparer<T> Create                                                              (PatchOdyssey.RefReadOnlyEqualityComparison<T> comparison, PatchOdyssey.RefReadOnlyHasher<T>? hasher = null)                    => new(comparison, hasher);
    ...
    public class RefReadOnlyList<T> : PatchOdyssey.Collections.IRefEquatable<RefReadOnlyList<T>>, System.Collections.Generic.IEnumerable<T>, System.Collections.Generic.IReadOnlyList<T>, System.Collections.IStructuralComparable, System.Collections.IStructuralEquatable, System.ICloneable /* ⟶ Based on `System.Collections.Generic.List<T>` and `System.Collections.ObjectModel.ReadOnlyCollection<T>` */ {
      ...
      [PatchMethod(AggressiveInlining)] public            int                           IndexOf                                                                  (in T element)                                                                                                                                                      => this.Items.IndexOf    (element);
      [PatchMethod(AggressiveInlining)] public            int                           IndexOf                                                                  (in T element, uint index)                                                                                                                                          => this.Items.IndexOf    (element, (int) index);
      ...
      [PatchMethod(AggressiveInlining)] public            int                           LastIndexOf                                                              (in T element)                                                                                                                                                      => this.Items.LastIndexOf(element);
      [PatchMethod(AggressiveInlining)] public            int                           LastIndexOf                                                              (in T element, uint index)                                                                                                                                          => this.Items.LastIndexOf(element, (int) index);
    ...
    public class RefSortedCollection<TSort, T> : PatchOdyssey.Collections.IRefEquatable<RefSortedCollection<TSort, T>>, System.Collections.Generic.IList<T>, System.Collections.ICollection, System.Collections.IList, System.Collections.IStructuralComparable, System.Collections.IStructuralEquatable, System.ICloneable /* ⟶ No read-only analogue */ {
      ...
      public  System.Collections.Generic.IComparer<TSort>     Comparer { get; private init; }                      =  System.Collections.Generic.Comparer<TSort>.Default;
      ...
      [PatchMethod(AggressiveInlining)] public RefSortedCollection(System.Collections.Generic.IComparer  <TSort>    comparer)                                                         : this(2u,                      comparer) {}
      ...
      [PatchMethod(AggressiveInlining)] public RefSortedCollection(System.Collections.Generic.IDictionary<TSort, T> dictionary, System.Collections.Generic.IComparer<TSort> comparer) : this((uint) dictionary.Count, comparer) { foreach (System.Collections.Generic.KeyValuePair<TSort, T> element in dictionary) this.Add(element); }
      [PatchMethod(AggressiveInlining)] public RefSortedCollection(uint                                             capacity,   System.Collections.Generic.IComparer<TSort> comparer)                                           { this.Comparer = comparer; this.items.EnsureCapacity(capacity); this.ranks.EnsureCapacity(capacity); }
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          ref T                                          Append                                                                              (in System.Collections.Generic.KeyValuePair <TSort, T>                                              element)                                                    { this.Add(element.Key, element.Value); return ref this.items[(uint) this.ranks.LastIndexOf(element.Key)]; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          ref T                                          Append                                                                              (in TSort                                                                                           rank, in T element)                                         { this.Add(in rank,     in element);    return ref this.items[(uint) this.ranks.LastIndexOf(in rank)]; }
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          bool                                           ContainsKey                                                                         (in TSort                                                rank)                                                                                                  => this.ranks.Contains(in rank);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          RefSortedCollection<TSort, U>                  ConvertAll<U>                                                                       (PatchOdyssey.RefConverter        <T, U>                 converter)                                                                                             { RefSortedCollection<TSort, U> sorted = new(this.Count, this.Comparer); this.items.ConvertAll(converter).CopyTo(sorted.items.Items); this.ranks.CopyTo(sorted.ranks.Items); sorted.items.Count = sorted.ranks.Count = this.Count; return sorted; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          RefSortedCollection<TSort, U>                  ConvertAll<U>                                                                       (PatchOdyssey.RefReadOnlyConverter<T, U>                 converter)                                                                                             => this      .ConvertAll([PatchMethod(AggressiveInlining)] (ref T element) => converter(in element));
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          void                                           CopyTo                                                                              (in PatchOdyssey.Collections.RefKeyValuePair<TSort, T>[] array)                                                                                                 => this      .CopyTo    (array, 0u);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          void                                           CopyTo                                                                              (in PatchOdyssey.Collections.RefKeyValuePair<TSort, T>[] array,    uint                                                    index)                               => this      .CopyTo    (0u, array, index, array.Length > index ? (uint) array.Length - index : 0u);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          void                                           CopyTo                                                                              (uint                                                    index,    in PatchOdyssey.Collections.RefKeyValuePair<TSort, T>[] array, uint arrayIndex, uint length) { for (; 0u != length-- && index < this.Count; ++index) array[arrayIndex++] = new(in this.ranks[index], in this.items[index]); }
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          bool                                           Exists                                                                              (PatchOdyssey.RefPredicate        <T>                    predicate)                                                                                             => this.items.Exists       (predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          bool                                           Exists                                                                              (PatchOdyssey.RefReadOnlyPredicate<T>                    predicate)                                                                                             => this.items.Exists       (predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          T?                                             Find                                                                                (PatchOdyssey.RefPredicate        <T>                    predicate)                                                                                             => this.items.Find         (predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          T?                                             Find                                                                                (PatchOdyssey.RefReadOnlyPredicate<T>                    predicate)                                                                                             => this.items.Find         (predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          T?                                             Find                                                                                (System.Predicate                 <T>                    predicate)                                                                                             => this.items.Find         (predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          PatchOdyssey.Collections.RefList<T>            FindAll                                                                             (PatchOdyssey.RefPredicate        <T>                    predicate)                                                                                             => this.items.FindAll      (predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          PatchOdyssey.Collections.RefList<T>            FindAll                                                                             (PatchOdyssey.RefReadOnlyPredicate<T>                    predicate)                                                                                             => this.items.FindAll      (predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            FindIndex                                                                           (PatchOdyssey.RefPredicate        <T>                    predicate)                                                                                             => this.items.FindIndex    (predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            FindIndex                                                                           (PatchOdyssey.RefReadOnlyPredicate<T>                    predicate)                                                                                             => this.items.FindIndex    (predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            FindIndex                                                                           (uint                                                    index, PatchOdyssey.RefPredicate        <T> predicate)                                                 => this.items.FindIndex    (index, predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            FindIndex                                                                           (uint                                                    index, PatchOdyssey.RefReadOnlyPredicate<T> predicate)                                                 => this.items.FindIndex    (index, predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            FindIndex                                                                           (uint                                                    index, uint                                 length, PatchOdyssey.RefPredicate        <T> predicate)    => this.items.FindIndex    (index, length, predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            FindIndex                                                                           (uint                                                    index, uint                                 length, PatchOdyssey.RefReadOnlyPredicate<T> predicate)    => this.items.FindIndex    (index, length, predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          T?                                             FindLast                                                                            (PatchOdyssey.RefPredicate        <T>                    predicate)                                                                                             => this.items.FindLast     (predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          T?                                             FindLast                                                                            (PatchOdyssey.RefReadOnlyPredicate<T>                    predicate)                                                                                             => this.items.FindLast     (predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          T?                                             FindLast                                                                            (System.Predicate                 <T>                    predicate)                                                                                             => this.items.FindLast     (predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            FindLastIndex                                                                       (PatchOdyssey.RefPredicate        <T>                    predicate)                                                                                             => this.items.FindLastIndex(predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            FindLastIndex                                                                       (PatchOdyssey.RefReadOnlyPredicate<T>                    predicate)                                                                                             => this.items.FindLastIndex(predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            FindLastIndex                                                                       (uint                                                    index, PatchOdyssey.RefPredicate        <T> predicate)                                                 => this.items.FindLastIndex(index, predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            FindLastIndex                                                                       (uint                                                    index, PatchOdyssey.RefReadOnlyPredicate<T> predicate)                                                 => this.items.FindLastIndex(index, predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            FindLastIndex                                                                       (uint                                                    index, uint                                 length, PatchOdyssey.RefReadOnlyPredicate<T> predicate)    => this.items.FindLastIndex(index, length, predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          void                                           ForEach                                                                             (PatchOdyssey.RefAction        <T>                       action)                                                                                                => this.items.ForEach      (action);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          void                                           ForEach                                                                             (PatchOdyssey.RefReadOnlyAction<T>                       action)                                                                                                => this.items.ForEach      (action);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            IndexOf                                                                             (in T                                                  element)                                                                                                 => this.items.IndexOf      (element);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            IndexOf                                                                             (in T                                                  element, uint index)                                                                                     => this.items.IndexOf      (element, index);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            IndexOf                                                                             (in T                                                  element, uint index, uint length)                                                                        => this.items.IndexOf      (element, index, length);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            LastIndexOf                                                                         (in T                                                  element)                                                                                                 => this.items.LastIndexOf  (element);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            LastIndexOf                                                                         (in T                                                  element, uint index)                                                                                     => this.items.LastIndexOf  (element, index);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          int                                            LastIndexOf                                                                         (in T                                                  element, uint index, uint length)                                                                        => this.items.LastIndexOf  (element, index, length);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(1)] public          bool                                           Remove                                                                              (in PatchOdyssey.Collections.RefKeyValuePair<TSort, T> element)                                                                                                 { for (uint index = 0u; index != this.Count; ++index) if (0 == this.Comparer.Compare(this.ranks[index], element.Key) && System.Collections.Generic.EqualityComparer<T>.Default.Equals(this.items[index], element.Value)) { this.RemoveAt(index); return true; } return false; }
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          uint                                           RemoveAll                                                                           (PatchOdyssey.RefPredicate                  <T>        predicate)                                                                                               { uint count = 0u; foreach (ref          T element in this.items) { count += this.Remove(in element) ? 1u : 0u; } return count; }
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          uint                                           RemoveAll                                                                           (PatchOdyssey.RefReadOnlyPredicate          <T>        predicate)                                                                                               { uint count = 0u; foreach (ref readonly T element in this.items) { count += this.Remove(in element) ? 1u : 0u; } return count; }
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          bool                                           TrueForAll                                                                          (PatchOdyssey.RefPredicate        <T>        predicate)                                                                                                         => this.items.TrueForAll(predicate);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] public          bool                                           TrueForAll                                                                          (PatchOdyssey.RefReadOnlyPredicate<T>        predicate)                                                                                                         => this.items.TrueForAll(predicate);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(0)] bool                                                           System.Collections.Generic.ICollection<T>.Remove                                    (T            element)                                                                                                                                          =>                                             this.Remove       (element);
      [PatchMethod(AggressiveInlining), PatchResolution(0)] System.Collections.Generic.IEnumerator<T>                      System.Collections.Generic.IEnumerable<T>.GetEnumerator                             ()                                                                                                                                                              => (System.Collections.Generic.IEnumerator<T>) this.GetEnumerator();
      [PatchMethod(AggressiveInlining), PatchResolution(0)] System.Collections.IEnumerator                                 System.Collections.IEnumerable.GetEnumerator                                        ()                                                                                                                                                              => (System.Collections.IEnumerator)            this.GetEnumerator();
    ...
    public class SharedList<T> : PatchOdyssey.Collections.IRefEquatable<SharedList<T>>, System.Collections.Generic.IList<T>, System.Collections.IList, System.Collections.IStructuralComparable, System.Collections.IStructuralEquatable, System.ICloneable {
      ...
      [PatchMethod(AggressiveInlining)] public bool                                           Equals                                                              (in SharedList            <T>    list)                                                                          =>     true;
      ...
      [PatchMethod(AggressiveInlining)] bool                                                  PatchOdyssey.Collections.IRefEquatable<SharedList<T>>.Equals        (ref SharedList           <T> list)                                                                             =>     this                                                 .Equals       (in list);
      [PatchMethod(AggressiveInlining)] bool                                                  PatchOdyssey.Collections.IRefReadOnlyEquatable<SharedList<T>>.Equals(in  SharedList           <T> list)                                                                             =>     this                                                 .Equals       (in list);
      ...
      [PatchMethod(AggressiveInlining)] object                                                System.ICloneable.Clone                                             ()                                                                                                              =>     this.Clone ();
      [PatchMethod(AggressiveInlining)] bool                                                  System.IEquatable<SharedList<T>>.Equals                             (SharedList<T> list)                                                                                            =>     this.Equals(list);
      ...
      public class GameObjectSharedList<T> : PatchOdyssey.Collections.SharedList<T>, PatchOdyssey.Collections.IRefEquatable<GameObjectSharedList<T>>, System.Collections.Generic.IList<T>, System.Collections.IList, System.Collections.IStructuralComparable, System.Collections.IStructuralEquatable, System.ICloneable where T : UnityEngine.Object /* ⟶ `UnityEngine.Component` or `UnityEngine.GameObject` */ {
        ...
        [PatchMethod(AggressiveInlining)] public                 bool                    Equals                                                                        (in GameObjectSharedList<T>    list)                                                                            =>     base                                                 .Equals       ((PatchOdyssey.Collections.SharedList<T>) list);
        ...
        [PatchMethod(AggressiveInlining)] bool                                           PatchOdyssey.Collections.IRefEquatable<GameObjectSharedList<T>>.Equals        (ref GameObjectSharedList<T> list)                                                                              =>     this                                                 .Equals       (in list);
        [PatchMethod(AggressiveInlining)] bool                                           PatchOdyssey.Collections.IRefReadOnlyEquatable<GameObjectSharedList<T>>.Equals(in  GameObjectSharedList<T> list)                                                                              =>     this                                                 .Equals       (in list);
        ...
        [PatchMethod(AggressiveInlining)] int                                            System.Collections.IStructuralEquatable.GetHashCode                           (System.Collections.IEqualityComparer comparer)                                                                 =>     0;
        [PatchMethod(AggressiveInlining)] object                                         System.ICloneable.Clone                                                       ()                                                                                                              =>     this.Clone ();
        [PatchMethod(AggressiveInlining)] bool                                           System.IEquatable<GameObjectSharedList<T>>.Equals                             (GameObjectSharedList<T> list)                                                                                  =>     this.Equals(list);
      }
    ...
    internal readonly struct WaitInfo : PatchOdyssey.Collections.IRefEquatable<WaitInfo> /* ⟶ Considered `UnityEngine.MonoBehaviour::Invoke[Repeating](nameof(𝑓) or ((System.Delegate) 𝑓).Method.Name, delay[, interval])` */ {
      ...
      [PatchConstructor, PatchMethod(AggressiveInlining)] internal WaitInfo(in PatchOdyssey.Collections.HandlerInfo<PatchOdyssey.Events.WaitEvent> handler)                                                                                   { this.events.Add(handler); }
      [PatchConstructor, PatchMethod(AggressiveInlining)] internal WaitInfo(UnityEngine.Coroutine                                                  coroutine, in PatchOdyssey.Collections.HandlerInfo<PatchOdyssey.Events.WaitEvent> handler) { this.events.Add(handler); this.coroutine = coroutine; }
...
namespace PatchOdyssey /* ⟶ …everything else */ {
  ...
  public static partial class Util /* ⟶ Utilities */ {
    ...
    public static class Reference<T> /* ⟶ Solely for `𝑓 Util.Reference<T>.*At(…)` */ {
      ...
      private  static readonly PatchOdyssey.ReadOnlySpanIndexer<T> ReadOnlySpanAt  = (PatchOdyssey.ReadOnlySpanIndexer<T>) (Traits.IsValueType<T>() ? ((PatchOdyssey.ReadOnlySpanIndexer<int>) Reference<int>.UnmanagedReadOnlySpanAt).Method.GetGenericMethodDefinition().MakeGenericMethod(typeof(T)).CreateDelegate(typeof(PatchOdyssey.ReadOnlySpanIndexer<T>)) : (PatchOdyssey.ReadOnlySpanIndexer<T>) Reference<T>.ManagedReadOnlySpanAt<T>);
      private  static readonly PatchOdyssey.SpanIndexer        <T> SpanAt          = (PatchOdyssey.SpanIndexer        <T>) (Traits.IsValueType<T>() ? ((PatchOdyssey.SpanIndexer        <int>) Reference<int>.UnmanagedSpanAt)        .Method.GetGenericMethodDefinition().MakeGenericMethod(typeof(T)).CreateDelegate(typeof(PatchOdyssey.SpanIndexer        <T>)) : (PatchOdyssey.SpanIndexer        <T>) Reference<T>.ManagedSpanAt        <T>);
      ...
      [PatchMethod(AggressiveInlining), PatchResolution(1)] public static ref          T Last(T[]                       array) => ref Reference<T>.At(array,   (uint) (0 != array.Length ? array.Length - 1 : 0));
    ...
    public static class Wait {
      ...
      /* … */
      // internal static readonly PatchOdyssey.Collections.RefSortedCollection<double, PatchOdyssey.Collections.WaitInfo> Pending = new()
      internal static readonly PatchOdyssey.Collections.RefDictionary<double, PatchOdyssey.Collections.WaitInfo> Pending = new(16) {{double.NaN, new()}};                                          // ⟶ Used `System.Collections.Generic.SortedDictionary<double, PatchOdyssey.Collections.WaitInfo>` prior
      ...
      /* … */
      [PatchMethod(AggressiveInlining)] public static uint Check         () => Util.Wait.CheckCoroutine();
      ...
      public static uint CheckTimer() {
        ...
        // PatchOdyssey.Collections.WaitInfo wait         = Util.Wait.Pending[double.NaN];
        ...
        //     if (double.IsNaN(waitDelay) || 0.0 >= waitDelay) { ++count; wait.events.Remove(waitHandler); }                                                                                                       // ⟶ Remove `ForTimerUntil(…)` handlers, or
        //     else wait.events[(uint) wait.events.IndexOf(waitHandler)] = new(waitHandler.value, waitHandler.target, new() {callback = waitHandler.metadata.callback, data = (waitDelay, timestamp + waitDelay)}); // ⟶ Update `ForTimerEvery(…)` handlers
      ...
      [PatchMethod(AggressiveInlining)]
      public static void Every(double delay, PatchOdyssey.Handler<PatchOdyssey.Events.WaitEvent> callback) => Util.Wait.ForCoroutineEvery(delay, callback);
      ...
      private static void ForCoroutine(double delay, PatchOdyssey.Handler<PatchOdyssey.Events.WaitEvent> callback, bool forever) {
        ...
        static System.Collections.IEnumerator EnumerateRoutine(double delay, bool forever) {
          do {
            ...
            if (0u == Util.Wait.Pending[delay].events.Count)
            break;

            Util.Wait.Pending[delay].events.Invoke();
          } while (forever);

          Util.Wait.Waiter.StopCoroutine(Util.Wait.Pending[delay].coroutine);
        }

        if (Util.Wait.Pending.TryGetValue(delay, out PatchOdyssey.Collections.WaitInfo wait))
          ...
          UnityEngine.Coroutine coroutine = Util.Wait.Waiter.StartCoroutine(EnumerateRoutine(delay, forever));
          Util.Wait.Pending.Add(delay, new(coroutine, new PatchOdyssey.Collections.HandlerInfo<PatchOdyssey.Events.WaitEvent>(callback, coroutine, new() {callback = callback, data = (delay, UnityEngine.Time.realtimeSinceStartupAsDouble + delay)})));
        }
      }

      [PatchMethod(AggressiveInlining)] public static void ForCoroutineEvery(double delay, PatchOdyssey.Handler<PatchOdyssey.Events.WaitEvent> callback) => Util.Wait.ForCoroutine(delay, callback, true);
      [PatchMethod(AggressiveInlining)] public static void ForCoroutineUntil(double delay, PatchOdyssey.Handler<PatchOdyssey.Events.WaitEvent> callback) => Util.Wait.ForCoroutine(delay, callback, false);
      [PatchMethod(AggressiveInlining)] public static void ForTimerEvery    (double delay, PatchOdyssey.Handler<PatchOdyssey.Events.WaitEvent> callback) => Util.Wait.Pending[double.NaN].events.Add(new(callback, null, new() {callback = callback, data = (+delay, UnityEngine.Time.realtimeSinceStartupAsDouble + delay)}));
      [PatchMethod(AggressiveInlining)] public static void ForTimerUntil    (double delay, PatchOdyssey.Handler<PatchOdyssey.Events.WaitEvent> callback) => Util.Wait.Pending[double.NaN].events.Add(new(callback, null, new() {callback = callback, data = (-delay, UnityEngine.Time.realtimeSinceStartupAsDouble + delay)}));

      [PatchMethod(AggressiveInlining)]
      public static uint StopCoroutine() {
        // … ⟶ Skip past the non-coroutine timer-based `double.NaN` entry — which is always sorted as first
        // using (System.Collections.Generic.SortedDictionary<double, PatchOdyssey.Collections.WaitInfo>.ValueCollection.Enumerator enumerator = Util.EnumeratorMoveTo(Util.Wait.Pending.Values.GetEnumerator(), 1u, false))
      ...
      [PatchMethod(AggressiveInlining)]
      public static uint StopCoroutine(PatchOdyssey.Handler<PatchOdyssey.Events.WaitEvent> callback) {
        // // … ⟶ Skip past the non-coroutine timer-based `double.NaN` entry — which is always sorted as first
        // using (System.Collections.Generic.SortedDictionary<double, PatchOdyssey.Collections.WaitInfo>.ValueCollection.Enumerator enumerator = Util.EnumeratorMoveTo(Util.Wait.Pending.Values.GetEnumerator(), 1u, false))
        // for (uint count = 0u; ; ) {
        //   if (enumerator.MoveNext()) {
      ...
      [PatchMethod(AggressiveInlining)]
      public static uint StopCoroutine(double delay, PatchOdyssey.Handler<PatchOdyssey.Events.WaitEvent> callback) {
        // uint count = 0u;

        // // …
        // if (!double.IsNaN(delay) && Util.Wait.Pending.TryGetValue(delay, out PatchOdyssey.Collections.WaitInfo wait)) {
      ...
      [PatchMethod(AggressiveInlining)]
      public static uint StopTimer() {
        Util.Wait.Pending[double.NaN].events.Clear();
        return 0u; // TODO
      }

      [PatchMethod(AggressiveInlining)]
      public static uint StopTimer(PatchOdyssey.Handler<PatchOdyssey.Events.WaitEvent> callback) {
        // uint                                                                              count        = 0u;
        // ref readonly PatchOdyssey.Collections.EventHandler<PatchOdyssey.Events.WaitEvent> waitHandlers = ref Util.Wait.Pending[double.NaN].events;
      ...
      [PatchMethod(AggressiveInlining)]
      public static uint StopTimer(double delay, PatchOdyssey.Handler<PatchOdyssey.Events.WaitEvent> callback) {
        // uint                                                                              count        = 0u;
        // ref readonly PatchOdyssey.Collections.EventHandler<PatchOdyssey.Events.WaitEvent> waitHandlers = ref Util.Wait.Pending[double.NaN].events;
      ...
      [PatchMethod(AggressiveInlining)]
      public static void Until(double delay, PatchOdyssey.Handler<PatchOdyssey.Events.WaitEvent> callback) => Util.Wait.ForCoroutineUntil(delay, callback);
    }
